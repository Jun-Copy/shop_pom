    ...
    <script type="text/javascript">
        function add_cart() {
            ...
            $.ajax({
                ...
                dataType:"jsonp",
                type:"GET",
                data:{"gId":gId,"gNumber":gNumber},
                jsonpCallback:"callBack",
                success:function (data) {
                    location.href="http://localhost:8085/cart/"+data;
                }
            })
        }
    </script>
...
<div class="shop_goods_bd clear">
    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="http://192.168.197.111/${images[0]}" jqimg="http://192.168.197.111/${images[0]}" width="350">
                </div>
                <div id="spec-n5">
                    ...
                    <div id="spec-list">
                        ...
                        <#list images as image>
                            <li><img src="http://192.168.197.111/${image}"> </li>
                        </#list>
                        </ul>
                    </div>
        ...
        <div class="shop_goods_show_right">
            <ul>
                <li>
                    <strong style="font-size:14px; font-weight:bold;">${goods.gdName}</strong>
                </li>
                <li>
                    <label>价格：</label>
                    <span><strong>${goods.gdPrice?string("￥#,###.##")}</strong>元</span>
                </li>
                <li>
                    <label>运费：</label>
                    <span>卖家承担运费</span>
                ...
                <li style="padding:20px 0;">
                    <label>&nbsp;</label>
                    <span><a class="goods_sub goods_sub_gou"  href="javascript:add_cart();" >加入购物车</a></span>
                </li>
            </ul>
        </div>
    </div>
